...
<body>
      ...
      <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
         ...
         <ul class="navbar-nav ml-auto">
             <li class="nav-item">
               <a class="Join" href="{{route('them_lop_hoc')}}" data-toggle="tooltip" title="Tạo lớp học"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-plus-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
   ...
   <h5>  @if (session('error'))
         ...
         <div class = "row">
            ...
            <div class= " col-3item col-sm-6 cel col-4  mb-3  ">
            ...
            <li class="nav-item dropdown">
             ...
             <div class="dropdown-menu dropdown-menu-right" >
               ...
               <a class="dropdown-item" href="{{route('Kich_sinh_vien_ra_khoi_lop',['id'=>$p->id])}}">Danh sách sinh viên</a>
             </div>
            </li>
         </ul>
