...
<body>
    ...
    <div class="form ">
        <div class="item_form1">
            ...
            <span></span>
            <a class="btn btn-primary" href="https://accounts.google.com/AccountChooser/signinchooser?continue=https%3A%2F%2Fclassroom.google.com%2Fh%3Fojcd%3D&flowName=GlifWebSignIn&flowEntry=AccountChooser" role="button">Chuyển đổi tài khoản</a>
    ...
    <div class="form">
        <div class="item_form2">
            ...
            <form class="modal-content animate" action="{{route('xl_tham_gia_lop_hoc')}}" method="post">
                 @csrf
                    <input id="code_Class" type="text" placeholder="Mã lớp" name="malophoc" required>
                    <button type="submit" class= "btnOnClick">Cập nhật thông tin</button>
            </form>
        </div>
    </div>
    <div class="form1">
